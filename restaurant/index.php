    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <h1><a class="navbar-brand" href="/restaurant/"><span>Beef</span>Club</a></h1>
            </div>
...
<div class="team" id="team">
    <div class="container">
        <div class="heading">
            <h3 data-aos="zoom-in" >Мероприятия</h3>
        </div>
        <div class="agile_team_grids">
            <div data-aos="fade-up" class="col-md-3 agile_team_grid">
                <div class="ih-item circle effect1">
                    <div class="spinner"></div>
                    <div class="img"><img src="images/af1.jpg"  alt=" " class="img-responsive" /></div>
                    <div class="info">
                        <div class="info-back">
            ...
            <div data-aos="slide-up" class="col-md-3 agile_team_grid">
                <div class="ih-item circle effect1">
                    <div class="spinner"></div>
                    <div class="img"><img src="images/af2.jpg" alt=" " class="img-responsive" /></div>
                    <div class="info">
                        <div class="info-back">
            ...
            <div data-aos="slide-up" class="col-md-3 agile_team_grid t3">
                <div class="ih-item circle effect1">
                    <div class="spinner"></div>
                    <div class="img"><img src="images/af3.jpg" alt=" " class="img-responsive" /></div>
                    <div class="info">
                        <div class="info-back">
            ...
            <div data-aos="fade-up" class="col-md-3 agile_team_grid t4">
                <div class="ih-item circle effect1">
                    <div class="spinner"></div>
                    <div class="img"><img src="images/af4.jpg" alt=" " class="img-responsive" /></div>
                    <div class="info">
                        <div class="info-back">
